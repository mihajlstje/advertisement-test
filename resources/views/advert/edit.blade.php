            ...
            <form method="POST" enctype="multipart/form-data" action="{{ route('advert.update', ['advert' => $advert->id]) }}">
                ...
                <div class="flex flex-col lg:flex-row mt-4">
                    <div class="w-full lg:w-4/12 lg:pe-2 mb-4 lg:mb-0">
                        ...
                        <x-category-selector id="category_id" :categories="$categories" :selectedId="$advert->category_id"></x-category-selector>
                    ...
                    <div class="w-full lg:w-4/12 lg:px-2 mb-4 lg:mb-0">
                        ...
                        <input type="number" name="price" value="{{ $advert->price }}" placeholder="{{ __('Enter product price') }}" id="price" class="rounded-none rounded-e-lg sm:text-xs bg-gray-50 border text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm border-gray-300 px-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        </div>
                ...
                <div class="flex flex-col lg:flex-row mt-4">
                    ...
                    <div class="w-full lg:w-6/12 lg:ps-2">
                        ...
                        <x-text-input id="phone" class="block mt-1 w-full" type="text" name="phone" :value="$advert->phone" placeholder="{{ __('Enter phone number') }}" autofocus />
                ...
                <div class="mt-4" x-data="image()">
                    ...
                    <div class="inline-block mt-4 cursor-pointer border-dashed border-2 border-sky-500" @click="$refs.image.click()">
                        <img src="{{ asset($advert->image) }}" class="basis-1/5 h-48 object-fit-cover" x-ref="imagePreview">
                    </div>
                </div>
